...
const Profile = () => {
  ...
  return <div className="div_14">
    ...
    <span onClick={()=>navigate("/")} className="mt-10 ml-20 cursor-pointer w-7">
      ⬅️
    </span>
      <form onSubmit={handleForm} className="div_15 ">
        <div className="flex justify-around">
          <div className="div_16">
            <h1 className="text-xl font-bold ">Complete @Mail</h1>
          ...
          <div className=" mt-20 ">
            <img src={image} alt="picture"
              className=" imge2 md:w-[350px] rounded-full h-[350px] shadow-lg shadow-violet-600 " />
